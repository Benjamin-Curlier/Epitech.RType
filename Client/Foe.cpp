...
Foe::Foe(sf::RenderWindow *w, sf::Vector2f pos, std::vector<S_sprite *> sprites, Main_Object_type *t, std::vector<Missile_Type *> m, Explosion_Type *e, int hp, int point) : IMainObject(w, pos, sprites, t, m, e)
{
	this->_hp = hp;
	this->_point = point;
}
